 ...
 //unconfirmed balance
  fetch('https://api.nanopool.org/v1/etc/payments/0x4f1578af53c5c17ec6e670f2f8021e4a97e9cbbe/1')
    ...
    .then(data => {
      ...
      const unconfirmedBalanceEtc = unconfirmedBalance + " ETC";

      document.getElementById('unconfirmed-balance').textContent = unconfirmedBalanceEtc;
    }
  );
  ...
  const walletAddress = '0x4F1578Af53C5C17Ec6E670F2F8021e4a97e9CbBe';
